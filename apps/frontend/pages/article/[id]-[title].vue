      ...
      <div class="flex-1 bg-white p-6 flex flex-col justify-between">
        <div class="flex-1">
          ...
          <div class="mt-3 text-base text-gray-900">
            <div class="flex gap-2 flex-col" v-html="articleHtml"></div>
          </div>
        </div>
...
const articleHtml = computed(() => {
  if (article && article.value.attributes.message) {
    let html = article.value.attributes.message;
    ...
    // add .article-html-link to all links
